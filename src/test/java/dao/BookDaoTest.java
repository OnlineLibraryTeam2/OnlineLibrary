...
public class BookDaoTest {
    ...
    public void takeBook() throws Exception {
        Book book  = new Book("Java8", 2010, "Technical", new Author("Oleg", "GG"), 5);
        assertTrue(bookDao.add(book));
        ...
        int remainingBookCount = ourAddedBook.get(0).getBookCount();
        assertEquals(book.getBookCount() - 1, remainingBookCount);
        assertTrue(bookDao.delete(book));
    }
    ...
    public void returnBook() throws Exception {
        ...
        assertEquals(book.getBookCount(), remainingBookCount);
        assertTrue(bookDao.delete(book));
    }

    @Test
    public void searchBookTitle() throws Exception {
        Book book1  = new Book("Java8", 2010, "Technical", new Author("Oleg", "GG"), 1);
        Book book2  = new Book("Java8", 2012, "Technical", new Author("Dmitry", "Petrov"), 1);
    ...
    public void searchByYear() throws Exception {
        Book book1  = new Book("Java8", 2010, "Technical", new Author("Oleg", "GG"), 1);
        Book book2  = new Book("Java Persistence API", 2010, "Technical", new Author("Andrey", "Vasilev"), 1);
        Book book3  = new Book("Spring Framework", 2010, "Technical", new Author("Johnny", "Goodwyn"), 1);
        assertTrue(bookDao.add(book1));
    ...
    public void recommendedBooks() throws Exception {
        ...
        Book book2  = new Book("Java Persistence API", 2010, "Technical", new Author("Andrey", "Vasilev"), 1);
        Book book3  = new Book("Spring Framework", 2010, "Technical", new Author("Johnny", "Goodwyn"), 1);
        Book book4  = new Book("Alice in Wonderland", 2010, "Fantasy", new Author("Lewis", "Carol"), 1);
        Book book5  = new Book("Bill Gates' life", 2011, "Biography", new Author("Peter", "Cowboy"), 1);
        Book book6  = new Book("Harry Potter", 2005, "Fantasy", new Author("J. K.", "Rowling"), 1);
        assertTrue(bookDao.add(book1));
        assertTrue(bookDao.add(book2));
        assertTrue(bookDao.add(book3));
